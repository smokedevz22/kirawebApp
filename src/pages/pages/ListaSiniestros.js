      ...
      <Grid justify="space-between" container spacing={24}>
        <Grid item>
          ...
          <Breadcrumbs aria-label="Breadcrumb" mt={2}>
            ...
            <Typography>SINIESTROS</Typography>
          </Breadcrumbs>
        </Grid>
        <Grid item>
          <div>
            <Route render={({ history }) => (
              ...
              <Button onClick={() => { history.push('/pages/flujo_siniestro') }} variant="contained" color="primary">
                <AddIcon />
             NUEVA DECLARACION
              </Button>
...
export default ListaSiniestros;
